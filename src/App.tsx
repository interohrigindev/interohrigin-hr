...
import ManualArticle from '@/routes/manual/article'
...
import RecruitmentSettings from '@/routes/recruitment/settings'
...
import EmployeeSignal from '@/routes/employee-signal'
...
import RecurringCheckPage from '@/routes/projects/recurring-check'
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            >
              ...
              <Route path="manual/article/:articleId" element={<ManualArticle />} />
              ...
              <Route path="employee-signal" element={<EmployeeSignal />} />
              ...
              <Route path="admin/projects/recurring-check" element={<RecurringCheckPage />} />
